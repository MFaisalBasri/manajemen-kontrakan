<div class="container-fluid bg-white text-dark p-3 ms-2 border-top border-primary">
    ...
    <div class="row">
        <div class="col-12 d-flex justify-content-end">
            <a href="<?php echo base_url(); ?>tambah-kontrakan"><button type="button" class="btn btn-primary ms-auto mb-2">Tambah Kontrakan</button></a>
        </div>
    </div>
            ...
            <tbody>
                ...
                <?php foreach ($kamar_list as $kamar_item) : ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo base_url('detail-kontrakan/' . $kamar_item['id']); ?>"><span class="badge text-bg-warning">Edit</span></a>
                            <a href="#" onclick="confirmDelete('<?php echo base_url('hapus-kontrakan/' . $kamar_item['id']); ?>')">
