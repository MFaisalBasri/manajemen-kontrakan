<div class="container-fluid">
    <div class="row d-flex justify-content-around">
        <div class="col-12 col-md-6 bg-white rounded-4 mb-3">
            <h3 class="text-center mt-3">Tambah Data Kontrakan</h3>
            ...
            <form action="<?php echo base_url(); ?>tambah-kontrakan" method="post" enctype="multipart/form-data">
                <div class="mb-3">
                    <input type="hidden" class="form-control" id="exampleFormControlInput1" name="id_pemilik" value="<?= session()->get('id') ?>">
                    <label for="exampleFormControlInput1" class="form-label">Kode Kontrakan</label>
                    <input type="input" class="form-control" id="exampleFormControlInput1" name="kode_kamar" value="<?= set_value('kode_kamar') ?>">

                    <label for="exampleFormControlInput1" class="form-label">Nomor Kontrakan</label>
