...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Nav Item - Dashboard -->
        <li class="nav-item <?= $title == 'Dashboard Pemilik' ? 'active' : ''; ?>">
            <a class="nav-link" href="<?php echo base_url(); ?>dashboard-pemilik">
        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse <?= $title == 'Data Kontrakan' ? 'show' : ($title == 'Tambah Kontrakan' ? 'show' : ($title == 'Data Admin' ? 'show' : '')); ?>
                    " aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Data Master:</h6>
                    <a class="collapse-item <?= ($title == 'Data Kontrakan' || $title == 'Tambah Kontrakan') ? 'active' : ''; ?>" href="<?php echo base_url(); ?>data-kontrakan-pemilik">Data Kontrakan</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item <?= $title == 'Data Penghuni' ? 'active' : ''; ?>">
            <a class="nav-link" href="<?php echo base_url(); ?>data-penghuni-kontrakan">
